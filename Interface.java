...
public class Interface
{
    ...
    public Interface()
    {
        model = new DefaultTableModel(new String[]{"Id","Duree","Process", "Priority","UID","AT"}, 0);
...
//        chartPanel.setPreferredSize(new Dimension(700, 10));
        ...
        computeBtn.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    int id = Integer.parseInt((String) model.getValueAt(i, 1));
                    int duree = Integer.parseInt((String) model.getValueAt(i, 1));
                    
                    //int remain = Integer.parseInt((String) model.getValueAt(i, 1));
                    
                    String process = (String) model.getValueAt(i, 0);
                    int priority = Integer.parseInt((String) model.getValueAt(i, 1));
                    int uid = Integer.parseInt((String) model.getValueAt(i, 1));
                    int at = Integer.parseInt((String) model.getValueAt(i, 1));
                    //int da = Integer.parseInt((String) model.getValueAt(i, 1));
                    //int dp = Integer.parseInt((String) model.getValueAt(i, 2));
                   ...
                   /* if (selected.equals("PSN") || selected.equals("PSP"))
                    ...
                    scheduler.add(new PCB(id,duree,process,priority, uid, at));
                }
                ...
                {
                    String process = (String) model.getValueAt(i, 0);
                    PCB pcb = scheduler.getPCB(process);
                    model.setValueAt(pcb.getDureeAttente(), i, 4);
                    model.setValueAt(pcb.getDureePassage(), i, 5);
                }
...
//                int width = 30;
                ...
                for (int i = 0; i < timeline.size(); i++)
                {
                    ...
                    g.drawString(event.getProgramName(), x + 10, y + 20);
